                ...
                <div className="flex flex-col lg:flex-row items-center justify-center px-3 md:px-0">
                    ...
                    <div className="lg:w-1/2 flex flex-col text-center lg:text-left order-first lg:order-first">
                        ...
                        <div className="flex items-center justify-center lg:justify-start gap-5">
                            <Link
                                href={i18n.language === 'es' ? 'https://drive.google.com/file/d/1yaeFqIJeDZUWS6APVDF-oAvOP4Or7UQM/view?usp=drive_link' : 'https://drive.google.com/file/d/1mbRPHPwk1ADlRseK7U7hAbn540B9WiEa/view?usp=sharing'}
                                target="_blank"
